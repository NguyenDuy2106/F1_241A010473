...
/// Widget gốc: cấu hình theme Material 3 và màn hình đầu tiên. 
...
class MyApp extends StatelessWidget { 
  ...
  Widget build(BuildContext context) { 
    ...
    return MaterialApp( 
      ...
      title: 'F1_241A010473', // TODO: thay bằng MSSV của bạn 
...
/// Màn hình chính: có trạng thái (số lượt thích) nên dùng StatefulWidget. 
...
class ProfileCard extends StatelessWidget { 
  ...
  Widget build(BuildContext context) { 
    ...
    // Lấy chữ cái đầu của tên (từ cuối trong họ tên tiếng Việt) 
